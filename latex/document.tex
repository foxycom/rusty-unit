...
\begin{itemize}
    ...
    \item \textbf{Struct initializations} generate new instances of a given struct, e.g., \texttt{let b = Book { name: "The Hobbit" }}. The object constructed in the statement defines the value and statement's type. A struct instantiation can have parameters whose values are assigned out of the set ~$\{v(s_k)~|~0 \leq k < i\}$.
