...
impl Date {
  fn from(day: u8, month: &str, year: u16) -> Result<Date, Error> {
    if month.to_lowercase().contains("feb") && day == 29 {
      // do leap year things ...
    }
...
fn Date::from(_1: u8, _2: &str, _3: u16) -> Result<Date, Error> {
  // Locals definition

  @bb0@: {
    _6 = _2;
    _5 = core::str::<impl str>::contains::<&str>(move _6, const "feb") -> @bb4@; §\label{line:mir-constant-analysis:string}§
  }
