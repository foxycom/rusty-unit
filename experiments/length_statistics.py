...
for crate in rs["Crate"].unique():
    rs_values = rs[rs["Crate"] == crate]["Length"]
    dynamosa_values = dynamosa[dynamosa["Crate"] == crate]["Length"]
...
print(f"RS average: {rs['Length'].mean()}")
print(f"RustyUnit average: {dynamosa['Length'].mean()}")
