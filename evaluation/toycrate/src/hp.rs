...
impl ParryHotter {
    ...
    pub fn aguamenti(&self, x: isize, y: isize) -> i32 {
        if y < 20 && x > 1000 {
            if x == 1001 {
                11
            } else {
            ...
            if y > -10 && y < 10 {
                if self.aqua_eructo(y as usize, x as u64, (x * 2) as u64) {
                    15
                } else {
                    10
                }
    ...
    pub fn accio(&self, x: i32, y: i32) -> i32 {
        if x < 20 {
            ...
            ParryHotter::aguamenti(self, x as isize, y as isize);
            if x * self.b < 100 {
                20
            } else {
                10
...
impl WonReasley {
    pub fn arania_exumai(&self, x: i64, y: i32) {
        if x > (y * 2) as i64 && y < -5000 {
            if y == - 5001 {
                println!("run");
            } else if y > -6000 {
                if self.y < -400 {
